...
export async function createFineTuningQuestion(
  ...
  try {
    ...
    if (!question) {
      throw new Error(
        "Failed to create fine-tuning question - no data returned"
      );
    }
    ...
    return {
      ...
      error:
        error instanceof Error
          ? error.message
          : "Failed to create fine-tuning question",
    };
  }
}

export async function updateFineTuningQuestion(
  id: string,
  questionData: Partial<FineTuningQuestion>
) {
  try {
    const {
      data: { session },
    ...
    return {
      ...
      error:
        error instanceof Error
          ? error.message
          : "Failed to update fine-tuning question",
    };
  }
}
  ...
  try {
    ...
    return {
      ...
      error:
        error instanceof Error
          ? error.message
          : "Failed to delete fine-tuning question",
    };
  }
}
